  ...
  return (
    <div className='top-section-wrapper flex-3'>
      ...
      <div id='tl-section-body'>
        ...
        New Jersey. We provide customized customer service to design and
        assemble the perfect sound to fit your individual needs.
      </div>
    </div>
  );
};

export default LandingTopLeftSection;
